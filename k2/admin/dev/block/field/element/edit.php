...
$K2->Menu('TAB');
$K2->Menu('TAB_SUB', array(array('Настройки', '/dev/block/edit.php?id='.$nBlock), array('Поля категорий', '/dev/block/field/category/?id='.$nBlock), array('Поля элементов', '/dev/block/field/element/?id='.$nBlock, 1)));
