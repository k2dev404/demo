...
$K2->Menu('TAB');
$K2->Menu('TAB_SUB', array(array('Настройки', '/dev/form/edit.php?id='.$nForm), array('Поля', '/dev/form/?id='.$nForm, 1)));
...
?><div class="content">
	...
	<form action="edit.php?id=<?=$_ID?>" method="post" class="form">
		...
		?><div class="saveBlock">
			...
			<p><input type="submit" class="sub" value="Сохранить"> или <a href="/k2/admin/dev/form/field/?id=<?=$nForm?>">отменить</a></p>
		</div>
	</form>
</div><?
