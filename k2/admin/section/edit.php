...
?>
	...
	<form method="post" enctype="multipart/form-data" class="form">
		...
		<div class="item">
			...
			<div class="field">
				<input type="text" name="NAME" value="<?=html($_POST['NAME'])?>" id="transcription-from">
			</div>
		</div>
		<div class="item">
			<div class="name">Папка<span class="star">*</span></div>
			<div class="field">
				<input type="text" name="FOLDER" value="<?=html($_POST['FOLDER'])?>" id="transcription-to">
				<a href="#" onclick="return k2.transcription.lock(this)" id="transcription-icon" class="icon lock" title="Автоматический перевод отключен"></a>
			</div>
		</div>
		<div class="item">
