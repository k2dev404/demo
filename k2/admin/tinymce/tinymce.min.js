...
!function (e, t) {
	...
	r(l, [], function () {
		...
		})), i.ie && i.ie < 9 && (B["float"] = "styleFloat", x(M, "set", {
		...
		function t(n) {
			...
			var H = this, P = n.doc, L = 0, O = 1, I = 2, F = !0, z = !1, W = "startOffset", V = "startContainer", U = "endContainer", $ = "endOffset", q = e.extend, j = n.nodeIndex;
			return q(H, {
				startContainer: P,
				startOffset: 0,
				endContainer: P,
		...
		return function (e) {
			...
			var v = this, y = {}, b = {}, C = [], x, w, _, E, N, k, S, T, R, A, B, D, M, H = {}, P = {};
		...
		function i(i, a) {
			...
			i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
				...
				var l = this, c, u = 0, d, f, p = [], h, m, g, v, y, b, C, x, w, _, E, N, k, S, T, R, A, B, D, M, H, P, L, O, I, F = 0, z = t.decode, W, V = n.makeMap("src,href,data,background,formaction,poster"), U = /((java|vb)script|mhtml):/i, $ = /^data:/i;
				for (P = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), L = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), H = i.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), _ = i.validate, b = i.remove_internals, W = i.fix_self_closing, O = a.getSpecialElements(); c = P.exec(e);) {
					if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6])d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d); else if (d = c[7]) {
						if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && H[d] && p.length > 0 && p[p.length - 1].name === d && o(d), !_ || (E = a.getElementRule(d))) {
							if (N = !0, _ && (T = E.attributes, R = E.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (N = !1), h = [], h.map = {}, S.replace(L, s)) : (h = [], h.map = {}), _ && !y) {
								if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, M = E.removeEmptyAttrs, M && !h.length && (N = !1), D)for (m = D.length; m--;)k = D[m], v = k.name, I = k.value, "{$uid}" === I && (I = "mce_" + F++), h.map[v] = I, h.push({
									name: v,
									value: I
								});
						...
						if (f = O[d]) {
							f.lastIndex = u = c.index + c[0].length, (c = f.exec(e)) ? (N && (g = e.substr(u, c.index - u)), u = c.index + c[0].length) : (g = e.substr(u), u = e.length), N && (g.length > 0 && l.text(g, !0), l.end(d)), P.lastIndex = u;
							continue
						}
		...
		return function (r, l) {
			...
			r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
				...
				var v, y, b, C, x, w, _, E, N, k, S, T, R, A = [], B, D, M, H, P, L, O, I;
				if (o = o || {}, p = {}, h = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), L = l.children, S = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, P = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, H = /^[ \t\r\n]+$/, v = new n({
						validate: S,
						...
						start: function (e, t, n) {
							...
							if (o = S ? l.getElementRule(e) : {}) {
								for (r = u(o.outputName || e, 1), r.attributes = t, r.shortEnded = n, b.append(r), s = L[b.name], s && L[r.name] && !s[r.name] && A.push(r), i = f.length; i--;)a = f[i].name, a in t.map && (N = h[a], N ? N.push(r) : h[a] = [r]);
		...
		return function (r, i) {
			...
			function a(t) {
				var n, r, o, a, s;
				n = t.screenX - T, r = t.screenY - R, L = n * k[2] + D, O = r * k[3] + M, L = 5 > L ? 5 : L, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && k[2] * k[3] !== 0, o && (W(n) > W(r) ? (O = V(L * H), L = V(O / H)) : (L = V(O / H), O = V(L * H))), C.setStyles(_, {
					width: L,
					height: O
					...
					top: s,
					display: "block"
				}), E.innerHTML = L + " &times; " + O, k[2] < 0 && _.clientWidth <= L && C.setStyle(_, "left", A + (D - L)), k[3] < 0 && _.clientHeight <= O && C.setStyle(_, "top", B + (M - O)), n = U.scrollWidth - $, r = U.scrollHeight - q, n + r !== 0 && C.setStyles(E, {
					left: a - n,
					top: s - r
				}), P || (i.fire("ObjectResizeStart", {target: w, width: D, height: M}), P = !0)
			}
			...
			function s() {
				...
				P = !1, e("width", L), e("height", O), C.unbind(I, "mousemove", a), C.unbind(I, "mouseup", s), F != I && (C.unbind(F, "mousemove", a), C.unbind(F, "mouseup", s)), C.remove(_), C.remove(E), z && "TABLE" != w.nodeName || l(w), i.fire("ObjectResized", {
					target: w,
					width: L,
					height: O
			...
			function l(e, t, r) {
				var l, u, d, f, p;
				g(), l = C.getPos(e, U), A = l.x, B = l.y, p = e.getBoundingClientRect(), u = p.width || p.right - p.left, d = p.height || p.bottom - p.top, w != e && (m(), w = e, L = O = 0), f = i.fire("ObjectSelected", {target: e}), o(e) && !f.isDefaultPrevented() ? x(N, function (e, i) {
					function o(t) {
			...
			function u(e) {
				...
				var n, i;
				if (!P)return x(C.select("img[data-mce-selected],hr[data-mce-selected]"), function (e) {
			...
			var C = i.dom, x = t.each, w, _, E, N, k, S, T, R, A, B, D, M, H, P, L, O, I = i.getDoc(), F = document, z = n.ie && n.ie < 11, W = Math.abs, V = Math.round, U = i.getBody(), $, q;
			N = {
				n: [.5, 0, 0, -1],
				e: [1, .5, 1, 0],
				s: [.5, 1, 0, 1],
			...
			return i.contentStyles.push(j + " div.mce-resizehandle {position: absolute;border: 1px solid black;background: #FFF;width: 5px;height: 5px;z-index: 10000}" + j + " .mce-resizehandle:hover {background: #000}" + j + " img[data-mce-selected], hr[data-mce-selected] {outline: 1px solid black;resize: none}" + j + " .mce-clonedresizable {position: absolute;" + (n.gecko ? "" : "outline: 1px dashed black;") + "opacity: .5;filter: alpha(opacity=50);z-index: 10000}" + j + " .mce-resize-helper {background: #555;background: rgba(0,0,0,0.75);border-radius: 3px;border: 1px;color: white;display: none;font-family: sans-serif;font-size: 12px;white-space: nowrap;line-height: 14px;margin: 5px 10px;padding: 5px;position: absolute;z-index: 10001}"), i.on("init", function () {
				z ? (i.on("ObjectResized", function (e) {
					...
					!P && /^(TABLE|IMG|HR)$/.test(t) && (i.selection.select(e.target, "TABLE" == t), i.nodeChanged())
		...
		var n = e.each;
		return {getCssText: t}
	}), r(O, [h, x, M, P, d, L], function (e, t, n, r, i, o) {
		return function (a) {
			function s(e) {
			...
			function v(t, n, r) {
				...
				if (d)if (r)r.nodeType ? (h = U.createRng(), h.setStartBefore(r), h.setEndAfter(r), l(M(h, u), null, !0)) : l(r, null, !0); else if (m && d.inline && !U.select("td.mce-item-selected,th.mce-item-selected").length)z("apply", t, n); else {
					var y = a.selection.getNode();
					K || !u[0].defaultBlock || U.getParent(y, U.isBlock) || v(u[0].defaultBlock), a.selection.setRng(o()), p = $.getBookmark(), l(M($.getRng(Z), u), p), d.styles && (d.styles.color || d.styles.textDecoration) && (lt(y, g, "childNodes"), g(y)), $.moveToBookmark(p), W($.getRng(Z)), a.nodeChanged()
				}
			}
			...
			function y(e, t, n, r) {
				function i(e) {
					var n, r, o, a, s;
					if (1 === e.nodeType && nt(e) && (a = y, y = "true" === nt(e), s = !0), n = st(e.childNodes), y && !s)for (r = 0, o = p.length; o > r && !P(p[r], t, e, e); r++);
					if (h.deep && n.length) {
				...
				function s(e, n, r, i) {
					...
					if (e) {
						for (u = e.parentNode, o = n.parentNode; o && o != u; o = o.parentNode) {
							for (a = U.clone(o, Q), c = 0; c < p.length; c++)if (P(p[c], t, a, a)) {
								a = 0;
								break
							}
				...
				function d(e) {
					...
					e = M(e, p, Z), h.split && (t = F(e, Z), n = F(e), t != n ? (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && /^(TH|TD)$/.test(n.nodeName) && n.firstChild && (n = n.firstChild || n), t = D(t, "span", {
						id: "_start",
						"data-mce-type": "bookmark"
					}), n = D(n, "span", {
						id: "_end",
						...
						at(e, function (e) {
							i(e), 1 === e.nodeType && "underline" === a.dom.getStyle(e, "text-decoration") && e.parentNode && "underline" === m(e.parentNode) && P({
								deep: !1,
								exact: !0,
								inline: "span",
			...
			function P(e, t, n, r) {
				...
				return "none" != e.remove ? (L(n, e), Z) : void 0
			}
			...
			function z(t, n, r, i) {
				...
				function p() {
					var e, t, i, a, s, l, d;
					e = $.getRng(!0), a = e.startOffset, l = e.startContainer, d = l.nodeValue, t = c($.getStart()), t && (i = u(t)), d && a > 0 && a < d.length && /\w/.test(d.charAt(a)) && /\w/.test(d.charAt(a - 1)) ? (s = $.getBookmark(), e.collapse(!0), e = M(e, f(n)), e = q.split(e), v(n, r, e), $.moveToBookmark(s)) : (t && i.nodeValue === X ? v(n, r, t) : (t = o(!0), i = t.firstChild, e.insertNode(t), a = 1, v(n, r, t)), $.setCursorLocation(i, a))
				}
				...
				function h() {
					...
					if (d)if (c)l = $.getBookmark(), e.collapse(!0), e = M(e, f(n), !0), e = q.split(e), y(n, r, e), $.moveToBookmark(l);
					else {
		...
		return function (i) {
			function o(o) {
				...
				function x() {
					...
					/^(OL|UL|LI)$/.test(n) && (F = "LI"), H = F ? y(F) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, L) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()), H.appendChild(a.doc.createTextNode(" ")), H.appendChild(L)) : L.parentNode.insertBefore(H, L) : e() ? (a.insertAfter(H, t()), h(H)) : (L = t(), S = k.cloneRange(), S.setStartAfter(B), S.setEndAfter(L), P = S.extractContents(), "LI" == F && "LI" == P.firstChild.nodeName ? (H = P.firstChild, a.insertAfter(P, L)) : (a.insertAfter(P, L), a.insertAfter(H, L))), a.remove(B), g(H), c.add()
				}
				...
				var k, S, T, R, A, B, D, M, H, P, L, O, I, F, z;
				if (k = s.getRng(!0), !o.isDefaultPrevented()) {
					if (!k.collapsed)return void i.execCommand("Delete");
					if (new t(a).normalize(k), R = k.startContainer, A = k.startOffset, F = (l.force_p_newlines ? "p" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", D = a.doc.documentMode, M = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = E(R)) {
						if (c.beforeChange(), !a.isBlock(T) && T != a.getRoot())return void((!F || M) && w());
						if ((F && !M || !F && M) && (R = C(R, A)), B = a.getParent(R, a.isBlock), L = B ? a.getParent(B.parentNode, a.isBlock) : null, O = B ? B.nodeName.toUpperCase() : "", I = L ? L.nodeName.toUpperCase() : "", "LI" != I || o.ctrlKey || (B = L, O = I), /^(LI|DT|DD)$/.test(O)) {
						...
						F && B === i.getBody() || (F = F || "P", b() ? (H = /^(H[1-6]|PRE|FIGURE)$/.test(O) && "HGROUP" != I ? y(F) : y(), l.end_container_on_empty_block && p(L) && a.isEmpty(B) ? H = a.split(L, B) : a.insertAfter(H, B), g(H)) : b(!0) ? (H = B.parentNode.insertBefore(y(), B), h(H), g(B)) : (S = k.cloneRange(), S.setEndAfter(B), P = S.extractContents(), _(P), H = P.firstChild, a.insertAfter(P, B), m(H), N(B), g(H)), a.setAttrib(H, "id", ""), i.fire("NewBlock", {newBlock: H}), c.add())
					}
				}
			}
	...
	}), r(W, [T, u, d, P, x, h], function (e, n, r, i, o, a) {
		...
		return function (r) {
			...
			var B, D, M, H = {state: {}, exec: {}, value: {}}, P = r.settings, L;
			r.on("PreInit", function () {
				B = r.dom, D = r.selection, P = r.settings, M = r.formatter
			}), l(this, {
				execCommand: v,
				queryCommandState: y,
				queryCommandValue: b,
				...
				"mceResetDesignMode,mceBeginUndoLevel": function () {
					...
					var r, i;
					n >= 1 && 7 >= n && (i = d(P.font_size_style_values), r = d(P.font_size_classes), n = r ? r[n - 1] || n : i[n - 1] || n), T(e, n)
					...
					var t, n, i;
					t = P.indentation, n = /[a-z%]+$/i.exec(t), t = parseInt(t, 10), y("InsertUnorderedList") || y("InsertOrderedList") ? k(e) : (P.forced_root_block || B.getParent(D.getNode(), B.isBlock) || M.apply("div"), s(D.getSelectedBlocks(), function (o) {
						if ("LI" != o.nodeName) {
				...
				"JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (e) {
					...
					return y("InsertUnorderedList") || y("InsertOrderedList") || !P.inline_styles && !!B.getParent(D.getNode(), "BLOCKQUOTE")
				}, "InsertUnorderedList,InsertOrderedList": function (e) {
		...
		return function (s) {
			...
			k(), m(), P(), it && (h(), v(), C(), R(), $(), _(), q(), U(), o.iOS ? (O(), I(), V()) : g()), rt && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), H()), o.ie >= 11 && (I(), W(), _()), o.ie && (g(), z(), j()), nt && (y(), b(), x(), S(), T(), A(), L(), F(), _())
		}
	}), r(lt, [$], function (e) {
		function t(t) {
		...
		var k = e.DOM, S = r.ThemeManager, T = r.PluginManager, R = w.extend, A = w.each, B = w.explode, D = w.inArray, M = w.trim, H = w.resolve, P = g.Event, L = x.gecko, O = x.ie;
		return N.prototype = {
			render: function () {
				function e() {
				...
				function t() {
					...
					w.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), A(r.external_plugins, function (e, t) {
						...
						if (e = M(e), e && !T.urls[e])if ("-" == e.charAt(0)) {
				...
				function e(n) {
					var r = T.get(n), i, o;
					i = T.urls[n] || t.documentBaseUrl.replace(/\/$/, ""), n = M(n), r && -1 === D(m, n) && (A(T.dependencies(n), function (t) {
						e(t)
				...
				if (!e) {
					if (i = n.getRng(), i.item && (o = i.item(0)), t._refreshContentEditable(), r || (x.opera || t.getBody().focus(), t.getWin().focus()), L || r) {
				...
				return "hash" === n ? (i = {}, "string" == typeof r ? A(r.split(r.indexOf("=") > 0 ? /[;,](?![^=;,]*(?:[;,]|$))/ : ","), function (e) {
					e = e.split("="), i[M(e[0])] = M(e.length > 1 ? e[1] : e)
				}) : i = r, i) : r
				...
				return e = e || {}, e.format = e.format || "html", e.get = !0, e.getInner = !0, e.no_events || t.fire("BeforeGetContent", e), n = "raw" == e.format ? r.innerHTML : "text" == e.format ? r.innerText || r.textContent : t.serializer.serialize(r, e), e.content = "text" != e.format ? M(n) : n, e.no_events || t.fire("GetContent", e), e.content
		...
		return e
	}), r(Ht, [Nt, Q, Y, Mt], function (e, t, n, r) {
		return e.extend({
	...
	}),a([l, c, u, d, f, p, h, m, g, y, b, C, x, _, E, N, k, S, T, R, A, B, D, M, H, P, O, I, F, z, W, V, U, $, q, j, Y, K, G, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Et, Nt, kt, St, Tt, Rt, At, Bt, Dt, Mt, Ht, Pt, Lt, Ot, It, Ft, zt, Wt, Vt, Ut, $t, qt, jt, Yt, Kt, Gt, Xt, Jt, Qt, Zt, en, tn, nn, rn, on, an, sn, ln])
}(this);